...
void CLunaLua::setupDefaults()
{
    ...
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_UNKNOWN);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_HIT);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_DESPAWN);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_CONTAINER);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_AI);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_EATEN);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_LINK);
    LUAHELPER_DEF_CONST(_G, NPC_TRANSFORMATION_CAUSE_SWITCH);
