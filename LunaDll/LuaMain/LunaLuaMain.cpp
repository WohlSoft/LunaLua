...
void CLunaLua::setupDefaults()
{
    ...
    _G["GL_FLOAT"]             = static_cast<unsigned int>(gl::GL_FLOAT);
    _G["GL_FLOAT_VEC2"]        = static_cast<unsigned int>(gl::GL_FLOAT_VEC2);
    _G["GL_FLOAT_VEC3"]        = static_cast<unsigned int>(gl::GL_FLOAT_VEC3);
    _G["GL_FLOAT_VEC4"]        = static_cast<unsigned int>(gl::GL_FLOAT_VEC4);
    _G["GL_FLOAT_MAT2"]        = static_cast<unsigned int>(gl::GL_FLOAT_MAT2);
    _G["GL_FLOAT_MAT3"]        = static_cast<unsigned int>(gl::GL_FLOAT_MAT3);
    _G["GL_FLOAT_MAT4"]        = static_cast<unsigned int>(gl::GL_FLOAT_MAT4);
    _G["GL_FLOAT_MAT2x3"]      = static_cast<unsigned int>(gl::GL_FLOAT_MAT2x3);
    _G["GL_FLOAT_MAT2x4"]      = static_cast<unsigned int>(gl::GL_FLOAT_MAT2x4);
    _G["GL_FLOAT_MAT3x2"]      = static_cast<unsigned int>(gl::GL_FLOAT_MAT3x2);
    _G["GL_FLOAT_MAT3x4"]      = static_cast<unsigned int>(gl::GL_FLOAT_MAT3x4);
    _G["GL_FLOAT_MAT4x2"]      = static_cast<unsigned int>(gl::GL_FLOAT_MAT4x2);
    _G["GL_FLOAT_MAT4x3"]      = static_cast<unsigned int>(gl::GL_FLOAT_MAT4x3);
    _G["GL_INT"]               = static_cast<unsigned int>(gl::GL_INT);
    _G["GL_INT_VEC2"]          = static_cast<unsigned int>(gl::GL_INT_VEC2);
    _G["GL_INT_VEC3"]          = static_cast<unsigned int>(gl::GL_INT_VEC3);
    _G["GL_INT_VEC4"]          = static_cast<unsigned int>(gl::GL_INT_VEC4);
    _G["GL_UNSIGNED_INT"]      = static_cast<unsigned int>(gl::GL_UNSIGNED_INT);
    _G["GL_UNSIGNED_INT_VEC2"] = static_cast<unsigned int>(gl::GL_UNSIGNED_INT_VEC2);
    _G["GL_UNSIGNED_INT_VEC3"] = static_cast<unsigned int>(gl::GL_UNSIGNED_INT_VEC3);
    _G["GL_UNSIGNED_INT_VEC4"] = static_cast<unsigned int>(gl::GL_UNSIGNED_INT_VEC4);
    _G["GL_DOUBLE"]             = static_cast<unsigned int>(gl::GL_DOUBLE);
    _G["GL_DOUBLE_VEC2"]        = static_cast<unsigned int>(gl::GL_DOUBLE_VEC2);
    _G["GL_DOUBLE_VEC3"]        = static_cast<unsigned int>(gl::GL_DOUBLE_VEC3);
    _G["GL_DOUBLE_VEC4"]        = static_cast<unsigned int>(gl::GL_DOUBLE_VEC4);
    _G["GL_DOUBLE_MAT2"]        = static_cast<unsigned int>(gl::GL_DOUBLE_MAT2);
    _G["GL_DOUBLE_MAT3"]        = static_cast<unsigned int>(gl::GL_DOUBLE_MAT3);
    _G["GL_DOUBLE_MAT4"]        = static_cast<unsigned int>(gl::GL_DOUBLE_MAT4);
    _G["GL_DOUBLE_MAT2x3"]      = static_cast<unsigned int>(gl::GL_DOUBLE_MAT2x3);
    _G["GL_DOUBLE_MAT2x4"]      = static_cast<unsigned int>(gl::GL_DOUBLE_MAT2x4);
    _G["GL_DOUBLE_MAT3x2"]      = static_cast<unsigned int>(gl::GL_DOUBLE_MAT3x2);
    ...
    module(L)
        [
            ...
            namespace_("Graphics")[
                ...
                def("getPixelData", &LuaProxy::Graphics::getPixelData, pure_out_value(boost::placeholders::_2) + pure_out_value(boost::placeholders::_3)),
            ...
            .def("getCurrentSpriteIndex", &LuaProxy::Player::getCurrentSpriteIndex, pure_out_value(boost::placeholders::_2) + pure_out_value(boost::placeholders::_3))
