...
int LuaProxy::Player::section(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
LuaProxy::Section LuaProxy::Player::sectionObj(lua_State *L)
{
	if(!isValid_throw(L))
		return Section(1);
...
RECT LuaProxy::Player::screen(lua_State *L)
{
	if(!isValid_throw(L))
		return RECT();
...
double LuaProxy::Player::x(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
int LuaProxy::Player::reservePowerup(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
void LuaProxy::Player::mem(int offset, LuaProxy::L_FIELDTYPE ftype, luabind::object value, lua_State *L)
{
	if(!isValid_throw(L))
		return;
...
bool LuaProxy::Player::isValid_throw(lua_State *L)
{
	if(!isValid()){
...
short LuaProxy::Player::toadDoubleJReady(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::sparklingEffect(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknownCTRLLock1(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknownCTRLLock2(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::quicksandEffectTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::onSlipperyGround(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::isAFairy(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::fairyAlreadyInvoked(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::fairyFramesLeft(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::sheathHasKey(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::sheathAttackCooldown(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::hearts(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::peachHoverAvailable(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::pressingHoverButton(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::peachHoverTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused1(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::peachHoverTrembleSpeed(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::peachHoverTrembleDir(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::itemPullupTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
float LuaProxy::Player::itemPullupMomentumSave(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused2(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unkClimbing1(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unkClimbing2(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unkClimbing3(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::waterState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::isInWater(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::waterStrokeTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknownHoverTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::slidingState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::slidingGroundPuffs(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::climbingState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknownTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknownFlag(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknownPowerupState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::slopeRelated(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::tanookiStatueActive(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::tanookiMorphCooldown(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::tanookiActiveFrameCount(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::isSpinjumping(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::spinjumpStateCounter(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::spinjumpLandDirection(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::currentKillCombo(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::groundSlidingPuffsState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::warpNearby(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown5C(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown5E(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::hasJumped(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
double LuaProxy::Player::curXPos(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
    return ::Player::Get(m_index)->momentum.x;
...
short LuaProxy::Player::uKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::dKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::lKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::rKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::jKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::sJKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::xKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::rNKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::sELKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::sTRKeyState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::facingDirection(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::mountType(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::mountColor(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::mountState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::mountHeightOffset(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::mountGfxIndex(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::currentPowerup(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::currentPlayerSprite(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused116(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
float LuaProxy::Player::gfxMirrorX(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::upwardJumpingForce(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::jumpButtonHeld(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::spinjumpButtonHeld(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::forcedAnimationState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
float LuaProxy::Player::unknown124(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
float LuaProxy::Player::unknown128(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::downButtonMirror(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::inDuckingPosition(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::selectButtonMirror(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown132(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::downButtonTapped(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown136(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
float LuaProxy::Player::xMomentumPush(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::deathState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::deathTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::blinkTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::blinkState(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown144(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::layerStateStanding(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::layerStateLeftContact(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::layerStateTopContact(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::layerStateRightContact(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::pushedByMovingLayer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused150(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused152(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::heldNPCIndex(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown156(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::powerupBoxContents(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::currentSection(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::warpTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown15E(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::projectileTimer1(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::projectileTimer2(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::tailswipeTimer(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown166(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
float LuaProxy::Player::takeoffSpeed(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::canFly(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::isFlying(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::flightTimeRemaining(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::holdingFlightRunButton(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::holdingFlightButton(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::nPCBeingStoodOnIndex(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown178(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unknown17A(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused17C(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused17E(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused180(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused182(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
...
short LuaProxy::Player::unused184(lua_State *L)
{
	if(!isValid_throw(L))
		return 0;
