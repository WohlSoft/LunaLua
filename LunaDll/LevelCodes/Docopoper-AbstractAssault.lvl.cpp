...
void AbstractAssaultCode() {
    ...
    char press_up = (demo->keymap.upKeyState != 0);
    char press_left = (demo->keymap.leftKeyState != 0);
    char press_down = (demo->keymap.downKeyState != 0);
    char press_right = (demo->keymap.rightKeyState != 0);
