...
#define DEF_GL_CONST(L, C) luasetconst(L, #C, static_cast<lua_Number>(gl::C))
...
static void LoadThread(void)
{
	...
	if (L == nullptr)
	{
		...
		lua_pushstring(L, LunaLua::EncodeUtils::WStr2Str(gAppPathWCHAR).c_str());
		...
		DEF_GL_CONST(L, GL_FLOAT);
		DEF_GL_CONST(L, GL_FLOAT_VEC2);
		DEF_GL_CONST(L, GL_FLOAT_VEC3);
		DEF_GL_CONST(L, GL_FLOAT_VEC4);
		DEF_GL_CONST(L, GL_FLOAT_MAT2);
		DEF_GL_CONST(L, GL_FLOAT_MAT3);
		DEF_GL_CONST(L, GL_FLOAT_MAT4);
		DEF_GL_CONST(L, GL_FLOAT_MAT2x3);
		DEF_GL_CONST(L, GL_FLOAT_MAT2x4);
		DEF_GL_CONST(L, GL_FLOAT_MAT3x2);
		DEF_GL_CONST(L, GL_FLOAT_MAT3x4);
		DEF_GL_CONST(L, GL_FLOAT_MAT4x2);
		DEF_GL_CONST(L, GL_FLOAT_MAT4x3);
		DEF_GL_CONST(L, GL_INT);
		DEF_GL_CONST(L, GL_INT_VEC2);
		DEF_GL_CONST(L, GL_INT_VEC3);
		DEF_GL_CONST(L, GL_INT_VEC4);
		DEF_GL_CONST(L, GL_UNSIGNED_INT);
		DEF_GL_CONST(L, GL_UNSIGNED_INT_VEC2);
		DEF_GL_CONST(L, GL_UNSIGNED_INT_VEC3);
		DEF_GL_CONST(L, GL_UNSIGNED_INT_VEC4);
		DEF_GL_CONST(L, GL_DOUBLE);
		DEF_GL_CONST(L, GL_DOUBLE_VEC2);
		DEF_GL_CONST(L, GL_DOUBLE_VEC3);
		DEF_GL_CONST(L, GL_DOUBLE_VEC4);
		DEF_GL_CONST(L, GL_DOUBLE_MAT2);
		DEF_GL_CONST(L, GL_DOUBLE_MAT3);
		DEF_GL_CONST(L, GL_DOUBLE_MAT4);
		DEF_GL_CONST(L, GL_DOUBLE_MAT2x3);
		DEF_GL_CONST(L, GL_DOUBLE_MAT2x4);
		DEF_GL_CONST(L, GL_DOUBLE_MAT3x2);
		DEF_GL_CONST(L, GL_DOUBLE_MAT3x4);
		DEF_GL_CONST(L, GL_DOUBLE_MAT4x2);
		DEF_GL_CONST(L, GL_DOUBLE_MAT4x3);
		DEF_GL_CONST(L, GL_SAMPLER_2D);
