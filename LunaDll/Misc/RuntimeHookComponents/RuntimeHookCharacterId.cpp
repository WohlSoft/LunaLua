...
static auto patch_0x8ECA95 = PATCH(0x8ECA95).CALL(HOOK_0x8ECA95).NOP_PAD_TO_SIZE<8>();
static auto patch_0x8ECDB0 = PATCH(0x8ECDB0).CALL(HOOK_0x8ECDB0).NOP_PAD_TO_SIZE<8>();
...
static auto patch_0x9953AC = PATCH(0x9953AC).CALL(HOOK_0x9953AC).NOP_PAD_TO_SIZE<7>();
