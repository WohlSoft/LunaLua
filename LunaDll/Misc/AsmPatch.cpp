...
/*static*/ bool MemoryUnlock::Memcpy(void* dest, const void* src, std::size_t count, const char* srcFile, int srcLine)
{
    AsmRange::getInst(reinterpret_cast<uintptr_t>(dest), srcFile, srcLine, count);
