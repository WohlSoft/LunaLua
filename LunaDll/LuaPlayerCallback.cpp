...
namespace LuaPlayerCallback {
	const int numCallbacks = 17; // The total number of callbacks
	...
	_PLAYERCALLBACK_DEFINE( 16, Callback_PlayerNPCID, Set_TranslateBlockContents, TranslateBlockContents);
}
