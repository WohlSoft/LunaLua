...
static const SMBXImageCategory smbxImageCategoryTile(           L"tile",                            400, GM_GFX_TILES_PTR_CONSTPTR, 0, GM_GFX_TILES_W_PTR_CONSTPTR, GM_GFX_TILES_H_PTR_CONSTPTR, nullptr, 1);
