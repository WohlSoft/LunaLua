...
#define DEFMEM_WITH_CONSTEXPR(name, type, addr) DEFMEM(name, type, addr); \
...
// MOB Related memory
DEFMEM_WITH_CONSTEXPR(GM_NPCS_PTR,         void*, 0x00B259E8);     // +0xAD58 + 0x20  to NPCs
DEFMEM_WITH_CONSTEXPR(GM_NPCS_COUNT,       WORD,  0x00B2595A);
DEFMEM_WITH_CONSTEXPR(GM_PLAYERS_PTR,      void*, 0x00B25A20);
DEFMEM(GM_PLAYERS_TEMPLATE, void*, 0x00B2C91C);     // Editor Template
DEFMEM_WITH_CONSTEXPR(GM_PLAYERS_COUNT,    WORD,  0x00B2595E);
...
DEFMEM_WITH_CONSTEXPR(GM_LEVEL_COUNT,      WORD,  0x00B25960);
DEFMEM_WITH_CONSTEXPR(GM_LEVEL_BASE,       void*, 0x00B25994);
...
// Background objects
DEFMEM_WITH_CONSTEXPR(GM_BGO_COUNT,        WORD,  0x00B25958);
DEFMEM_WITH_CONSTEXPR(GM_BGOS_PTR,         void*, 0x00B259B0);

// Warps
DEFMEM_WITH_CONSTEXPR(GM_WARP_COUNT,       WORD,  0x00B258E2);
DEFMEM_WITH_CONSTEXPR(GM_WARPS_PTR,        void*, 0x00B258F4);

// Water/Quicksand areas
DEFMEM_WITH_CONSTEXPR(GM_WATER_AREA_COUNT, WORD,  0x00B25700);
DEFMEM_WITH_CONSTEXPR(GM_WATER_AREAS_PTR,  void*, 0x00B256F4);
...
// Events
DEFMEM_WITH_CONSTEXPR(GM_EVENTS_PTR,       void*, 0x00B2C6CC);
DEFMEM(GM_EVENT_TIMES_PTR,  void*, 0x00B2D104);     // array of 100 shorts
DEFMEM_WITH_CONSTEXPR(GM_EVENT_COUNT,      WORD,  0x00B2D710);

// Blocks
DEFMEM_WITH_CONSTEXPR(GM_BLOCK_COUNT,      WORD,  0x00B25956);
DEFMEM_WITH_CONSTEXPR(GM_BLOCKS_PTR,       void*, 0x00B25A04);
...
// Animations
DEFMEM_WITH_CONSTEXPR(GM_ANIM_COUNT,       WORD,  0x00B2595C);
DEFMEM_WITH_CONSTEXPR(GM_ANIM_PTR,         void*, 0x00B259CC);

// Tile
DEFMEM_WITH_CONSTEXPR(GM_TILE_COUNT,       WORD,   0x00B257A4);
DEFMEM_WITH_CONSTEXPR(GM_TILE_PTR,         void*,  0x00B25910);

// Scenery
DEFMEM_WITH_CONSTEXPR(GM_SCENERY_COUNT,    WORD,   0x00B257A6);
DEFMEM_WITH_CONSTEXPR(GM_SCENERY_PTR,      void*,  0x00B2592C);

// Path
DEFMEM_WITH_CONSTEXPR(GM_PATH_COUNT,       WORD,   0x00B258E0);
DEFMEM_WITH_CONSTEXPR(GM_PATH_PTR,         void*,  0x00B258D4);

// Musicbox
DEFMEM_WITH_CONSTEXPR(GM_MUSICBOX_COUNT,   WORD,   0x00B25980);
DEFMEM_WITH_CONSTEXPR(GM_MUSICBOX_PTR,     void*,  0x00B25974);
