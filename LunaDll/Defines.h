...
enum NPCTransformationCause {
    NPC_TRANSFORMATION_CAUSE_UNKNOWN = 0,
    NPC_TRANSFORMATION_CAUSE_HIT = 1,
    NPC_TRANSFORMATION_CAUSE_DESPAWN = 2,
    NPC_TRANSFORMATION_CAUSE_CONTAINER = 3,
    NPC_TRANSFORMATION_CAUSE_AI = 4,
    NPC_TRANSFORMATION_CAUSE_EATEN = 5,
    NPC_TRANSFORMATION_CAUSE_LINK = 6,
    NPC_TRANSFORMATION_CAUSE_SWITCH = 7,
    };
