...
ExternalProject_Add(
    ...
    CMAKE_ARGS "-DCMAKE_INSTALL_PREFIX=${LUABIND_INSTALL_DIR}" "-DBOOST_ROOT=${BoostSourceDir}" "-DLUA_LIBRARIES=${LUAJIT_LIBRARY_FILES}" "-DLUA_INCLUDE_DIR=${LUAJIT_INCLUDE_DIR}" "-DBUILD_TESTING=FALSE"
)
